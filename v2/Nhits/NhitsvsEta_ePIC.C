...
void NhitsvsEta_ePIC(Double_t mom=5.0)
  {
   ...
   gStyle->SetOptStat(0);
     ...
     // MC Track Properties
    TString InDIR = "/gpfs02/eic/mposik/ePIC/hits/pre-TDRv2/npsim/default/rootfiles";
    TFile* file = new TFile(Form("%s/npsim_25.10.0_pi-_%0.1fGeV_3deg_177deg_0.0deg_360.0deg_1.edm4eic.root",InDIR.Data(),mom)); // Tree with tracks and hits
																   TFile* ofile = new TFile(Form("./Output/Nhitsvsmom_%.1f_hist.root",mom),"recreate");
    ofile->cd();
