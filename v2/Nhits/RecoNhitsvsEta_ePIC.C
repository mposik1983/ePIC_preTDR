...
void RecoNhitsvsEta_ePIC(Double_t mom=1.0)
  {
   ...
   gStyle->SetOptStat(0);
     ...
     // MC Track Properties
    TString InDIR = "/gpfs02/eic/mposik/ePIC/hits/pre-TDRv2/eicrecon/default/rootfiles";
    TFile* file = new TFile(Form("%s/eicrecon_v1.30.0_25.10.0_pi-_%0.1fGeV_3deg_177deg_0.0deg_360.0deg_tracking_only_1.podio.root",InDIR.Data(),mom)); // Tree with tracks and hits
																   TFile* ofile = new TFile(Form("./Output/RecoNhitsvsmom_%.1f_hist.root",mom),"recreate");
    ofile->cd();
  ...
  TTreeReaderArray<Float_t> *vtx_si_x, *vtx_si_y, *vtx_si_z;
  TTreeReaderArray<Float_t> *barrel_si_x, *barrel_si_y, *barrel_si_z; 
  TTreeReaderArray<Float_t> *disks_si_x, *disks_si_y, *disks_si_z; 
  TTreeReaderArray<Float_t> *endcap_etof_x, *endcap_etof_y, *endcap_etof_z;
  TTreeReaderArray<Float_t> *barrel_mm_x, *barrel_mm_y, *barrel_mm_z;
  TTreeReaderArray<Float_t> *barrel_tof_x, *barrel_tof_y, *barrel_tof_z;
  TTreeReaderArray<Float_t> *out_mm_x, *out_mm_y, *out_mm_z; 
  TTreeReaderArray<Float_t> *endcap_fmm_x, *endcap_fmm_y, *endcap_fmm_z; 
  TTreeReaderArray<Float_t> *endcap_bmm_x, *endcap_bmm_y, *endcap_bmm_z; 
  ...
  TTreeReaderArray<Int_t> *vtx_si_quality, *barrel_si_quality, *disks_si_quality, *endcap_etof_quality, *barrel_mm_quality, *barrel_tof_quality, *out_mm_quality, *endcap_fmm_quality,      *endcap_bmm_quality; 	
   ...
   // Hits on detectors
   // SVT IB
   vtx_si_x = new TTreeReaderArray<Float_t>(myReader, "SiBarrelVertexRecHits.position.x"); 
   vtx_si_y = new TTreeReaderArray<Float_t>(myReader, "SiBarrelVertexRecHits.position.y"); 
   vtx_si_z = new TTreeReaderArray<Float_t>(myReader, "SiBarrelVertexRecHits.position.z"); 
   vtx_si_quality = new TTreeReaderArray<Int_t>(myReader, "VertexBarrelHits.quality");
   
   // SVT OB
   barrel_si_x = new TTreeReaderArray<Float_t>(myReader, "SiBarrelTrackerRecHits.position.x"); 
   barrel_si_y = new TTreeReaderArray<Float_t>(myReader, "SiBarrelTrackerRecHits.position.y"); 
   barrel_si_z = new TTreeReaderArray<Float_t>(myReader, "SiBarrelTrackerRecHits.position.z");
   barrel_si_quality = new TTreeReaderArray<Int_t>(myReader, "SiBarrelHits.quality");
   
   // SVT Disks
   disks_si_x = new TTreeReaderArray<Float_t>(myReader, "SiEndcapTrackerRecHits.position.x"); 
   disks_si_y = new TTreeReaderArray<Float_t>(myReader, "SiEndcapTrackerRecHits.position.y"); 
   disks_si_z = new TTreeReaderArray<Float_t>(myReader, "SiEndcapTrackerRecHits.position.z");
   disks_si_quality = new TTreeReaderArray<Int_t>(myReader, "TrackerEndcapHits.quality");
   
   // ETOF Hits
   endcap_etof_x = new TTreeReaderArray<Float_t>(myReader, "TOFEndcapRecHits.position.x"); 
   endcap_etof_y = new TTreeReaderArray<Float_t>(myReader, "TOFEndcapRecHits.position.y"); 
   endcap_etof_z = new TTreeReaderArray<Float_t>(myReader, "TOFEndcapRecHits.position.z");
   endcap_etof_quality = new TTreeReaderArray<Int_t>(myReader, "TOFEndcapHits.quality"); 
    
   // Inner MPGD
   barrel_mm_x = new TTreeReaderArray<Float_t>(myReader, "MPGDBarrelRecHits.position.x"); 
   barrel_mm_y = new TTreeReaderArray<Float_t>(myReader, "MPGDBarrelRecHits.position.y"); 
   barrel_mm_z = new TTreeReaderArray<Float_t>(myReader, "MPGDBarrelRecHits.position.z");
   barrel_mm_quality = new TTreeReaderArray<Int_t>(myReader, "MPGDBarrelHits.quality");  
   
   // BarrelTOF
   barrel_tof_x = new TTreeReaderArray<Float_t>(myReader, "TOFBarrelRecHits.position.x"); 
   barrel_tof_y = new TTreeReaderArray<Float_t>(myReader, "TOFBarrelRecHits.position.y"); 
   barrel_tof_z = new TTreeReaderArray<Float_t>(myReader, "TOFBarrelRecHits.position.z");
   barrel_tof_quality = new TTreeReaderArray<Int_t>(myReader, "TOFBarrelHits.quality");  
   
    //Outer MPGD Hits
   out_mm_x = new TTreeReaderArray<Float_t>(myReader, "OuterMPGDBarrelRecHits.position.x"); 
   out_mm_y = new TTreeReaderArray<Float_t>(myReader, "OuterMPGDBarrelRecHits.position.y"); 
   out_mm_z = new TTreeReaderArray<Float_t>(myReader, "OuterMPGDBarrelRecHits.position.z");
   out_mm_quality = new TTreeReaderArray<Int_t>(myReader, "OuterMPGDBarrelHits.quality");
   
    //Forward MPGD 
   endcap_fmm_x = new TTreeReaderArray<Float_t>(myReader, "ForwardMPGDEndcapRecHits.position.x"); 
   endcap_fmm_y = new TTreeReaderArray<Float_t>(myReader, "ForwardMPGDEndcapRecHits.position.y"); 
   endcap_fmm_z = new TTreeReaderArray<Float_t>(myReader, "ForwardMPGDEndcapRecHits.position.z");
   endcap_fmm_quality = new TTreeReaderArray<Int_t>(myReader, "ForwardMPGDEndcapHits.quality");    
   
   //Backward MPGD 
   endcap_bmm_x = new TTreeReaderArray<Float_t>(myReader, "BackwardMPGDEndcapRecHits.position.x"); 
   endcap_bmm_y = new TTreeReaderArray<Float_t>(myReader, "BackwardMPGDEndcapRecHits.position.y"); 
   endcap_bmm_z = new TTreeReaderArray<Float_t>(myReader, "BackwardMPGDEndcapRecHits.position.z");
  ...
  TH2D* hEtaP = new TH2D("hEtaP", "#eta vs. Momentum", 100, 0,20,100,-4,4);
    hEtaP->GetXaxis()->SetTitle("P_{mc} [GeV]");
    hEtaP->GetXaxis()->CenterTitle();
    hEtaP->GetYaxis()->SetTitle("#eta_{mc}");
    hEtaP->GetYaxis()->CenterTitle();
    ...
    //  if (eta_Track<3.4) continue; // Looks for the hits in a given eta range
     ...
     for (int j = 0; j < vtx_si_x->GetSize(); ++j){
       ...
       hitPos.push_back(TVector3(xhit,yhit,zhit));
     }
    ...
    for (int j = 0; j < disks_si_x->GetSize(); ++j){
      ...
      if (zhit>0) hitPos.push_back(TVector3(xhit,yhit,zhit));
      else if (zhit<0) hitPos.push_back(TVector3(xhit,yhit,zhit));      
    }
  ...
  hits->Draw("hist");
  hits->Write();
  c1->SaveAs(Form("./Output/RecoNhitsvsmom%1.1f.png",mom));
  c1->SaveAs(Form("./Output/RecoNhitsvsmom%1.1f.root",mom));
  ofile->Close();
}
