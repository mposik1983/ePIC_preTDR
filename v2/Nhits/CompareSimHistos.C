...
void CompareSimHistos(){
 TFile *f_MPGD_0   = TFile::Open("./Output/SimHits/Nhitsvsmom_0.5_hist.root");
 TFile *f_noMPGD_0 = TFile::Open("./Output/SimHits/Nhitsvsmom_0.5_noMPGD_hist.root");
 TFile *f_MPGD_1   = TFile::Open("./Output/SimHits/Nhitsvsmom_1.0_hist.root");
 TFile *f_noMPGD_1 = TFile::Open("./Output/SimHits/Nhitsvsmom_1.0_noMPGD_hist.root");
 TFile *f_MPGD_2   = TFile::Open("./Output/SimHits/Nhitsvsmom_2.0_hist.root");
 TFile *f_noMPGD_2 = TFile::Open("./Output/SimHits/Nhitsvsmom_2.0_noMPGD_hist.root");
 TFile *f_MPGD_3   = TFile::Open("./Output/SimHits/Nhitsvsmom_5.0_hist.root");
 TFile *f_noMPGD_3 = TFile::Open("./Output/SimHits/Nhitsvsmom_5.0_noMPGD_hist.root");
 TFile *f_MPGD_4   = TFile::Open("./Output/SimHits/Nhitsvsmom_10.0_hist.root");
 TFile *f_noMPGD_4 = TFile::Open("./Output/SimHits/Nhitsvsmom_10.0_noMPGD_hist.root");
